...
class TrainerVAE(object):
    ...
    def train(self, generator, support_sets, reconstructor):
        ...
        #support_sets_optim_LBFGS = torch.optim.LBFGS(
        #    support_sets.parameters(),
        #    lr=1.0,
        #    tolerance_grad=1e-5,
        ...
        for iteration in range(starting_iter, self.params.max_iter + 1):
            ...
            if torch.rand(1)>=0.5:
                ...
                img_shifted = generator.inference(2*z - latent2)
                img_shifted2 = generator.inference(2*z - latent1)

            # Predict support sets indices
            ...
            classification_loss = self.cross_entropy(predicted_support_sets_indices,
