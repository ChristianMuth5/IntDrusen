...
def main():
    ...
    dataset_noise = {"data_source": "Duke", "method": "noise", "remove_below_line": True, "image_size": 128,
                     "minimum_drusen_height": 5}
    dataset_ffdnet = {"data_source": "Duke", "method": "FFDNet", "remove_below_line": True, "image_size": 128,
                      "minimum_drusen_height": 5}
    dataset_gauss = {"data_source": "Duke", "method": "Gauss2", "remove_below_line": True, "image_size": 128,
                     "minimum_drusen_height": 5}
    dataset_bim = {"data_source": "Duke", "method": "BiM", "remove_below_line": True, "image_size": 128,
                   "minimum_drusen_height": 5}
    dataset_overview = {"data_source": "Duke", "method": "overview", "remove_below_line": True, "image_size": 128,
                   "minimum_drusen_height": 5}
    # dataset5 = {"data_source": "Duke", "method": "median", "remove_below_line": True, "image_size": 128,
    #            "minimum_drusen_height": 5}

    # Valid train_method values:
    # GAN, classic simple GAN architecture
    # GANComplex, has more layers, more trainable parameters
    # StyleGAN, use StyleGAN
    model_gan_10_10 = {"train_method": "GAN", "num_epochs": 10, "latent_size": 10, "augment_data": True, "mix": False, "loss": "bce"}
    model_gan_200_20_mix_bce = {"train_method": "GAN", "num_epochs": 200, "latent_size": 20, "augment_data": True, "mix": True, "loss": "bce"}
    model_gan_200_20_mix_mse = {"train_method": "GAN", "num_epochs": 200, "latent_size": 20, "augment_data": True, "mix": True, "loss": "mse"}
    model_gan_100_10 = {"train_method": "GAN", "num_epochs": 100, "latent_size": 10, "augment_data": True, "mix": False, "loss": "bce"}
    model_gancomplex_100_10 = {"train_method": "GANComplex", "num_epochs": 100, "latent_size": 10, "augment_data": True, "mix": False, "loss": "bce"}
    model_gan_100_20 = {"train_method": "GAN", "num_epochs": 100, "latent_size": 20, "augment_data": True, "mix": False, "loss": "bce"}
    model_gan_200_10 = {"train_method": "GAN", "num_epochs": 200, "latent_size": 10, "augment_data": True, "mix": False, "loss": "bce"}
    model_gan_200_20 = {"train_method": "GAN", "num_epochs": 200, "latent_size": 20, "augment_data": True, "mix": False, "loss": "bce"}
    model_gan_10_20 = {"train_method": "GAN", "num_epochs": 10, "latent_size": 20, "augment_data": True, "mix": False, "loss": "bce"}
    ...
    latent_warp_1k = {"method": "warp", "latent_steps": 100}
    ...
    runs.append({"dataset": dataset_bim, "model": model_gan_10_20, "latent_method": latent_warp_1k})
